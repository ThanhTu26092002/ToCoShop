...
function productdetails({ detall }) {
    ...
    <div className='main_product_detall'>
      ...
      <div className="detail">
        ...
        <div className="product_detall_container">
          ...
          <div className="product_detall">
            <div className="product_detall_main">
              ...
              <ul>
                <li><img src="image50.png"/><span>BẢO HÀNH TRONG VÒNG 90 NGÀY</span></li>
                <li><img src="image50.png"/><span>ĐỔI HÀNG TRONG VÒNG 30 NGÀY</span></li>
                <li><img src="image50.png"/><span>HOTLINE BÁN HÀNG: 0914 444 179</span></li>
              </ul>
        ...
        <div className="description">
          ...
          <br />
          <p>Sản phẩm của shop đảm bảo chất lượng tuyệt đối. Chất liệu đẹp, form dáng chuẩn. Và đặc biệt shop chuyên những mặt hàng tầm trung cho đến cao cấp không bán những mặt hàng rẻ, kém chất lượng. Khách hàng khi order sẽ được ship COD nên nếu sản phẩm không làm hài lòng quý khách hàng thì có thể ko thanh toán và gửi trả lại.</p>
          <br />
